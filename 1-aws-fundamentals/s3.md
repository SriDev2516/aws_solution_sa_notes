...
- The principle in the policy represents the account or the user for which the policy 
  applies to
- The size of the S3 bucker policy is limited (Bucket policies are limited to 20 KB in 
  size).
